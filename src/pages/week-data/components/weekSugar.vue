<template>
  <div class="report_item_wrapper">
    ...
    <div class="nodata" v-if="!echartShows">{{$t('tag.bloodsugar.noweek')}}</div>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    getEchartsDataInfo () {
      ...
      this.$axios.getWeekbloodsugar(postData)
    ...
    getEchartsDataInfoSucc (res) {
      ...
      if (res.code === 0 && res.data) {
        ...
        this.content = this.$t('bloodsugar.week.a1')+getData.ave.value+ this.$t('bloodsugar.week.'+this.statec)
