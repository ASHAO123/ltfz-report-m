          ...
          <table>
            ...
            <tbody>
              ...
              <tr v-for="(days, index) in calendar" :key="index">
                ...
                <td
                  :style="{
                      'color': day.currentDay && ! day.selected ? '#fff' :(! day.selected&&!day.currentDay)?'#757575' : '',
                      'background-color': day.currentDay ? 'rgba(78,112,157,0.9)' : ''
                     }"
                  :class="[{
...
.calendar-body td.selected {
  ...
  color: #fff;
  cursor: pointer;
  background-color:rgba(78,112,157,0.5);
}
