<template>
  <div class="report_item_wrapper">
    ...
    <div class="nodata" v-show="!echartShows">{{$t('tag.zangfu.nomonth')}}</div>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    getEchartsDataInfo () {
      ...
      this.$axios.getMonthviscera(postData)
    ...
    getEchartsDataInfoSucc (res) {
      ...
      if (res.code === 0 && res.data) {
        ...
        this.content = this.$t('zangfu.month.'+this.statec)
