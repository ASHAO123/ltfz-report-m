<template>
  <article class="cur_con_wrapper">
    <div class="cur_con">
      <header class="header">
        <i class="iconfont">&#xe60e;</i>
        <h2>{{$t('title.bloodsugar')}}<span>({{ startTime }} -- {{ endTime }})</span></h2>
      </header>
      <div class="charts">
        <div class="data">
          <keep-alive>
        ...
        <ul class="item_list">
            <li>
              ...
              <p class="title">{{$t('tag.bloodsugar.current')}}</p>
            </li>
            <li>
              ...
              <div class="title">{{$t('tag.bloodsugar.todatAve')}}</div>
            </li>
            <li>
              ...
              <p class="title">{{$t('tag.bloodsugar.todayTop')}}</p>
            </li>
        </ul>
        <ul class="item_list">
            <li>
              ...
              <p class="title">{{$t('tag.bloodsugar.todaylowest')}}</p>
            </li>
            <li>
              ...
              <p class="title">{{$t('tag.bloodsugar.yesTop')}}</p>
            </li>
            <li>
              ...
              <p class="title">{{$t('tag.bloodsugar.yealowest')}}</p>
            </li>
        </ul>
      </div>
      <div class="read">
...
export default {
  ...
  data () {
    return {
      ...
      contentShow: false,
      tipShow: false,
      contentRandom: this.$t('tag.canshujieduContent.sugar')
    }
  },
  mounted () {
  ...
  methods: {
    getCurrentDataInfo () {
      ...
      this.$axios.getCurrentBloodsugar(postData).then(this.getCurrentDataInfoSucc)
    },
